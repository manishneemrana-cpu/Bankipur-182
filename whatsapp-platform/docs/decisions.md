...
- Redis-backed job queue, audit log writers.
...
- Retrying delivery for outbound webhooks — Phase 10 built one-shot signed delivery
  (`docs/api.md`); a failed delivery is recorded but never retried.
